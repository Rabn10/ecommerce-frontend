                            ...
                            <div className="row pt-3">
                                ...
                                <div className="col-mb-3">
                                    <textarea
                                        ...
                                        className={`form-control ${errors.address && "is-invalid"}`} placeholder='Address' rows={3}></textarea>
                                    {
                                ...
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <input
                                            ...
                                            type="text" className={`form-control ${errors.mobile && "is-invalid"}`} placeholder='mobile no' />
                                        {
